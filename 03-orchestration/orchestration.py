...
@task(retries=3, retry_delay_seconds=2, name='Read taxi data', description='Read data into DataFrame')
...
def train_best_model(
    ...
    with mlflow.start_run():
        ...
        # added markdown artifact to display last RMSE in Prefect UI (for Q4)
